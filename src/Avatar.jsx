        ...
        <g transform="translate(-825.000000, -1100.000000)" id="Avataaar/Circle">
          <g transform="translate(825.000000, 1100.000000)">
            <g id="Circle" strokeWidth="1" fillRule="evenodd" transform="translate(12.000000, 40.000000)">
              ...
              <use id="Circle-Background" fill="#E6E6E6" xlinkHref="#react-path-1"></use>
            ...
            <g id="Mask"></g>
            <g id="Avataaar" strokeWidth="1" fillRule="evenodd" mask="url(#react-mask-5)">
              <g id="Body" transform="translate(32.000000, 36.000000)">
                ...
                <path
                  ...
                  id="Neck-Shadow" fillOpacity="0.100000001" fill="#000000" mask="url(#react-mask-6)"></path>
              </g>
              <g id="Clothing/Overall" transform="translate(0.000000, 170.000000)">
                ...
                <mask id="react-mask-180" fill="white">
                  <use xlinkHref="#react-path-179"></use>
                </mask>
                <use id="Overall" fill="#B7C1DB" fillRule="evenodd" xlinkHref="#react-path-179"></use>
                <g id="Color/Palette/Gray-01" mask="url(#react-mask-180)" fillRule="evenodd" fill="#3C4F5C">
              ...
              <g id="Face" transform="translate(76.000000, 82.000000)" fill="#000000">
                <g id="Mouth/Grimace" transform="translate(2.000000, 52.000000)">
                  <defs>
                    <rect id="react-path-9" x="24" y="9" width="60" height="22" rx="11"></rect>
                  </defs>
                  <rect id="Mouth" fillOpacity="0.599999964" fill="#000000" fillRule="evenodd" x="22" y="7" width="64"
                    height="26" rx="13"></rect>
                  <mask id="react-mask-10" fill="white">
                    <use xlinkHref="#react-path-9"></use>
                  </mask>
                  <use id="Mouth" fill="#FFFFFF" fillRule="evenodd" xlinkHref="#react-path-9"></use>
                  <path
                    ...
                    id="Grimace-Teeth" fill="#E6E6E6" fillRule="evenodd" mask="url(#react-mask-10)"></path>
                </g>
                ...
                <g id="Eyebrow/Natural/Angry-Natural" fillOpacity="0.599999964">
                  <path
                    ...
                    id="Eyebrows-The-Web"
                    transform="translate(28.094701, 12.127505) rotate(17.000000) translate(-28.094701, -12.127505) "></path>
                  <path
              ...
              <g id="Top">
                <defs>
                  <rect id="react-path-156" x="0" y="0" width="264" height="280"></rect>
                  <path
                    ...
                    id="react-path-154"></path>
                  <filter x="-0.7%" y="-1.7%" width="101.4%" height="106.8%" filterUnits="objectBoundingBox"
                    id="react-filter-151">
                  ...
                  <path
                    ...
                    id="react-path-155"></path>
                </defs>
                <mask id="react-mask-152" fill="white">
                  <use xlinkHref="#react-path-156"></use>
                </mask>
                <g id="Mask"></g>
                <g id="Top/Accessories/Winter-Hat-3" transform="translate(-1.000000, 0.000000)">
                  <g id="hat" strokeWidth="1" fillRule="evenodd" transform="translate(67.000000, 12.000000)">
                    ...
                    <mask id="react-mask-153" fill="white">
                      <use xlinkHref="#react-path-154"></use>
                    </mask>
                    <use id="hat-mask" fill="#D8D8D8" xlinkHref="#react-path-154"></use>
                    <g id="Color/Palette/Gray-01" mask="url(#react-mask-153)" fillRule="evenodd" fill="#25557C">
                      <rect id="🖍Color" x="0" y="0" width="264" height="280"></rect>
                    </g>
                  </g>
                  <g id="hat-front">
                    <use fill="black" fillOpacity="1" filter="url(#react-path-155)" xlinkHref="#react-path-155"></use>
                    <use fill="#F4F4F4" fillRule="evenodd" xlinkHref="#react-path-155"></use>
                  </g>
                  <g id="Facial-Hair/Beard-Majestic" transform="translate(49.000000, 72.000000)">
                    <defs>
                      <path
                        ...
                        id="react-path-158"></path>
                    </defs>
                    <mask id="react-mask-157" fill="white">
                      <use xlinkHref="#react-path-158"></use>
                    </mask>
                    <use id="Glorious-Beard" fill="#5E7AA9" fillRule="evenodd" xlinkHref="#react-path-158"></use>
                    <g id="Color/Hair/Brown" mask="url(#react-mask-157)" fill="#C93305">
